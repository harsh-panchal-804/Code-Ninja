...
const BrutalistButton: React.FC<BrutalistButtonProps> = ({ onClick }) => {
  return (
    <div className="button-container">
      ...
      <style jsx>{`  
        ...
        .button-1::before { left: -100%; }
        .button-1::after  { left: 100%; }
        .button-1:hover::before { animation: swipeRight 1.5s infinite; }
        .button-1:hover::after  { animation: swipeLeft 1.5s infinite; }

        @keyframes swipeRight { 100% { transform: translateX(200%) skew(-45deg); } }
        @keyframes swipeLeft  { 100% { transform: translateX(-200%) skew(-45deg); } }
        ...
        .brutalist-button:hover .openai-icon {
          animation: spin-and-zoom 2s ease infinite;
        }
