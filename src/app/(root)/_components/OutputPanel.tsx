        ...
        <div className="flex items-center gap-4">
          ...
          <button
            ...
            className={
              ...
              (hasContent
                ? "text-gray-400 hover:text-gray-300 bg-[#1e1e2e] rounded-lg ring-1 ring-gray-800/50 hover:ring-gray-700/50 transition-all"
                : "text-gray-600 bg-[#1e1e2e] rounded-lg ring-1 ring-gray-800/20 cursor-not-allowed")
            }
          >
            {isCopied ? (
              <>
